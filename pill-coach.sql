...
CREATE TABLE `receta` (
  ...
  `nombreDoctor` text COLLATE utf8_unicode_ci NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
...
INSERT INTO `receta` (`id_Receta`, `username_Paciente`, `id_Medicina`, `cantidadConsumo`, `tabletasConsumo`, `frecuenciaHoraDosis`, `diasDosis`, `nombreDoctor`) VALUES
(15, 'Jj522', 19, 0, 1, 4, 4, 'Joaquin Lopez'),
