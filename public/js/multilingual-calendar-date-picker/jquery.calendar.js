...
(function($) {
  ...
  function initCalendar(wrapper, options) {
    ...
    headerLabel.bind('click', function() {
      ...
      //triggerSelectEvent(options.onSelect); * SE ELIMINO PARA FUNCIONES DE LA APP
    });
  ...
  function triggerSelectEvent(event) {
	...
	*/
    ...
    if (event != undefined) {
      //event({ date: date, label: label.join('.') }); * SE CAMBIO PARA USO DE LA APP
